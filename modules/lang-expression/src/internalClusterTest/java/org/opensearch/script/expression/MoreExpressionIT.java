...
public class MoreExpressionIT extends OpenSearchIntegTestCase {
    ...
    public void testBasic() throws Exception {
        createIndex("test");
        ensureGreen("test");
        client().prepareIndex("test", "_doc", "1").setSource("foo", 4).setRefreshPolicy(IMMEDIATE).get();
    ...
    public void testScore() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("text", "hello goodbye"),
            client().prepareIndex("test", "_doc", "2").setSource("text", "hello hello hello goodbye"),
            client().prepareIndex("test", "_doc", "3").setSource("text", "hello hello goodebye")
        );
    ...
    public void testDateMethods() throws Exception {
        OpenSearchAssertions.assertAcked(prepareCreate("test").addMapping("_doc", "date0", "type=date", "date1", "type=date"));
        ensureGreen("test");
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("id", 1, "date0", "2015-04-28T04:02:07Z", "date1", "1985-09-01T23:11:01Z"),
            client().prepareIndex("test", "_doc", "2").setSource("id", 2, "date0", "2013-12-25T11:56:45Z", "date1", "1983-10-13T23:15:00Z")
        );
    ...
    public void testMultiValueMethods() throws Exception {
        OpenSearchAssertions.assertAcked(
            prepareCreate("test").addMapping("_doc", "double0", "type=double", "double1", "type=double", "double2", "type=double")
        );
        ensureGreen("test");
        ...
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource(doc1),
            client().prepareIndex("test", "_doc", "2").setSource(doc2),
            client().prepareIndex("test", "_doc", "3").setSource(doc3)
        );
    ...
    public void testInvalidDateMethodCall() throws Exception {
        OpenSearchAssertions.assertAcked(prepareCreate("test").addMapping("_doc", "double", "type=double"));
        ensureGreen("test");
        indexRandom(true, client().prepareIndex("test", "_doc", "1").setSource("double", "178000000.0"));
        try {
    ...
    public void testSparseField() throws Exception {
        OpenSearchAssertions.assertAcked(prepareCreate("test").addMapping("_doc", "x", "type=long", "y", "type=long"));
        ensureGreen("test");
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("id", 1, "x", 4),
            client().prepareIndex("test", "_doc", "2").setSource("id", 2, "y", 2)
        );
    ...
    public void testMissingField() throws Exception {
        createIndex("test");
        ensureGreen("test");
        client().prepareIndex("test", "_doc", "1").setSource("x", 4).setRefreshPolicy(IMMEDIATE).get();
        try {
    ...
    public void testParams() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("id", 1, "x", 10),
            client().prepareIndex("test", "_doc", "2").setSource("id", 2, "x", 3),
            client().prepareIndex("test", "_doc", "3").setSource("id", 3, "x", 5)
        );
    ...
    public void testCompileFailure() {
        client().prepareIndex("test", "_doc", "1").setSource("x", 1).setRefreshPolicy(IMMEDIATE).get();
        try {
    ...
    public void testNonNumericField() {
        client().prepareIndex("test", "_doc", "1").setSource("text", "this is not a number").setRefreshPolicy(IMMEDIATE).get();
        try {
    ...
    public void testInvalidGlobalVariable() {
        client().prepareIndex("test", "_doc", "1").setSource("foo", 5).setRefreshPolicy(IMMEDIATE).get();
        try {
    ...
    public void testSpecialValueVariable() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("x", 5, "y", 1.2),
            client().prepareIndex("test", "_doc", "2").setSource("x", 10, "y", 1.4),
            client().prepareIndex("test", "_doc", "3").setSource("x", 13, "y", 1.8)
        );
    ...
    public void testStringSpecialValueVariable() throws Exception {
        ...
        assertAcked(client().admin().indices().prepareCreate("test").addMapping("_doc", "text", "type=keyword").get());
        ensureGreen("test");
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("text", "hello"),
            client().prepareIndex("test", "_doc", "2").setSource("text", "goodbye"),
            client().prepareIndex("test", "_doc", "3").setSource("text", "hello")
        );
    ...
    public void testInvalidUpdateScript() throws Exception {
        try {
            ...
            indexRandom(true, client().prepareIndex("test_index", "_doc", "1").setSource("text_field", "text"));
    ...
    public void testPipelineAggregationScript() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("agg_index", "_doc", "1").setSource("one", 1.0, "two", 2.0, "three", 3.0, "four", 4.0),
            client().prepareIndex("agg_index", "_doc", "2").setSource("one", 2.0, "two", 2.0, "three", 3.0, "four", 4.0),
            client().prepareIndex("agg_index", "_doc", "3").setSource("one", 3.0, "two", 2.0, "three", 3.0, "four", 4.0),
            client().prepareIndex("agg_index", "_doc", "4").setSource("one", 4.0, "two", 2.0, "three", 3.0, "four", 4.0),
            client().prepareIndex("agg_index", "_doc", "5").setSource("one", 5.0, "two", 2.0, "three", 3.0, "four", 4.0)
        );
    ...
    public void testBoolean() throws Exception {
        XContentBuilder xContentBuilder = XContentFactory.jsonBuilder()
            ...
            .field("type", "boolean");
        xContentBuilder.endObject().endObject().endObject().endObject();
        assertAcked(prepareCreate("test").addMapping("_doc", xContentBuilder));
        ensureGreen();
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("id", 1, "price", 1.0, "vip", true),
            client().prepareIndex("test", "_doc", "2").setSource("id", 2, "price", 2.0, "vip", false),
            client().prepareIndex("test", "_doc", "3").setSource("id", 3, "price", 2.0, "vip", false)
        );
        // access .value
    ...
    public void testFilterScript() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("test", "_doc", "1").setSource("id", 1, "foo", 1.0),
            client().prepareIndex("test", "_doc", "2").setSource("id", 2, "foo", 0.0)
        );
