...
public class QueryRescorerIT extends OpenSearchIntegTestCase {
    public void testEnforceWindowSize() throws Exception {
        createIndex("test");
        // this
            ...
            for (int i = 0; i < numDocs - 4; i++) {
                ...
                assertBusy(() -> {
                    ...
                    if ("total".equals(scoreMode) || "".equals(scoreMode)) {
                        assertFirstHit(rescored, hasId(String.valueOf(j + 1)));
                        assertSecondHit(rescored, hasId(String.valueOf(j)));
                        assertThirdHit(rescored, hasId(String.valueOf(j + 2)));
                        ...
                        assertFirstHit(rescored, hasId(String.valueOf(j + 2)));
                        assertSecondHit(rescored, hasId(String.valueOf(j + 1)));
                        assertThirdHit(rescored, hasId(String.valueOf(j)));
                        ...
                        assertFirstHit(rescored, hasId(String.valueOf(j + 1)));
                        assertSecondHit(rescored, hasId(String.valueOf(j + 2)));
                        assertThirdHit(rescored, hasId(String.valueOf(j)));
                        assertThat(
