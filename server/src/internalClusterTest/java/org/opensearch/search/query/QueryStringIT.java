...
public class QueryStringIT extends OpenSearchIntegTestCase {
    ...
    private void doAssertOneHitForQueryString(String queryString) throws Exception {
        assertBusy(() -> {
    ...
    private void doAssertLimitExceededException(String queryString, int exceedingFieldCount, String inputFieldPattern) throws Exception {
        assertBusy(() -> {
